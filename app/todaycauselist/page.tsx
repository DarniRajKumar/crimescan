    ...
    <div className="welcome-page-container bg-gray-50">
      ...
      <div className="welcome-content-wrapper bg-white text-black">
        ...
        <div className="cards-grid">
          <div className="court-card filtered-cases" onClick={() => window.open(process.env.NODE_ENV === 'production' ? 'https://lcc-ai.netlify.app/dailycauselist507' : '/dailycauselist507', '_blank')}>
          ...
          <div className="court-card all-cases" onClick={() => window.open(process.env.NODE_ENV === 'production' ? 'https://lcc-ai.netlify.app/dcl1' :'/dcl1', '_blank')}>
          ...
          <div className="court-card case-search" onClick={() => window.open(process.env.NODE_ENV === 'production' ? 'https://lcc-ai.netlify.app/case-search' : '/case-search', '_blank')}>
          ...
          <div className="court-card high-priority-cases" onClick={() => window.open(process.env.NODE_ENV === 'production' ? 'https://lcc-ai.netlify.app/highpriorityv2' : '/highpriorityv2', '_blank')}>
